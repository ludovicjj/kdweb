 ...
 */
final class Version20210609124425 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Update Users fields';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE users ADD author_id INT DEFAULT NULL, ADD registered_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD account_must_be_verified_before DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD registration_token VARCHAR(255) DEFAULT NULL, ADD is_verified TINYINT(1) NOT NULL, ADD account_verified_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD forgot_password_token VARCHAR(255) DEFAULT NULL, ADD forgot_password_token_requested_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD forgot_password_token_must_be_verified_before DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD forgot_password_token_verified_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users DROP author_id, DROP registered_at, DROP account_must_be_verified_before, DROP registration_token, DROP is_verified, DROP account_verified_at, DROP forgot_password_token, DROP forgot_password_token_requested_at, DROP forgot_password_token_must_be_verified_before, DROP forgot_password_token_verified_at');
    }
}
